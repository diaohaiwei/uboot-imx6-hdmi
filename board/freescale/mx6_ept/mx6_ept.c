...
//int board_early_init_f_flag = 0;
int board_early_init_f(void)
{
	//board_early_init_f_flag = 1;
	setup_iomux_uart();
...
/*
 * This section requires the differentiation between iMX6 EPlanet boards, but
